...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "XTREME~XMD~DU8RmKaS#y8t2P3E1bCdMfsnITbWaIjTEDp0q4fDEqO0PhmKnfuU",
// add your Session Id 
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*_© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇᴠ xᴛʀᴇᴍᴇ_*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/41i4rb.jpg",
